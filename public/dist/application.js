...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'tsdriverapp';
...
ApplicationConfiguration.registerModule('drivers');
	...
	function($scope, $stateParams, Authentication, Drivers, $modal, $log) {
		...
		this.modalUpdate = function (size, selectedDriver) {
			...
			var modalInstance = $modal.open({
				...
				controller: ["$scope", "$modalInstance", "driver", function($scope, $modalInstance, driver) {
					$scope.driver = driver;
